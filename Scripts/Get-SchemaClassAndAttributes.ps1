...
<#
    ...
    .EXAMPLE
    Get-SchemaClassAndAttributes.ps1
    

    .EXAMPLE
    Get-SchemaClassAndAttributes.ps1 -Name ms-DS-Key-Credential-Link
    Retreives the schema attributes by name

    .EXAMPLE
    Get-SchemaClassAndAttributes.ps1 -LDAPDisplayName msDS-KeyCredentialLink
    Retreives the schema attributes by LDAPDisplayName

    .EXAMPLE
    Get-SchemaClassAndAttributes.ps1 -schemaIDGUID 5b47d60f-6090-40b2-9f37-2a4de88f3063
    Retreives the schema attributes and matches by provided GUID

    .EXAMPLE
    Get-SchemaClassAndAttributes.ps1 -All -Path .\All.CSV
