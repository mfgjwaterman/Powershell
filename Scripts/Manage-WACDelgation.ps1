...
<#
    ...
    .EXAMPLE
    Manage-WACDelgation.ps1 -Computername "prod-mgmt" -Identity "OU=Servers,DC=corp,DC=Domain,DC=Com"
    ...
    .EXAMPLE
    Manage-WACDelgation.ps1 -Clean -Identity "OU=Servers,DC=corp,DC=Domain,DC=Com" 
    Get all the enabled servers in the given OU, and cleans 
    the msDS-AllowedToActOnBehalfOfOtherIdentity attribute.
    
    .EXAMPLE
    Manage-WACDelgation.ps1 -List -Identity "OU=Servers,DC=corp,DC=Domain,DC=Com" 
